...
final class AlbumsTVC: LibraryTVC {
	...
	private lazy var a_album_promote = UIAction(title: InterfaceText.Move_Up, image: UIImage(systemName: "arrow.up.circle.fill")?.applying_hierarchical_tint()) { [weak self] _ in self?.promote_albums() }
	private lazy var a_album_demote = UIAction(title: InterfaceText.Move_Down, image: UIImage(systemName: "arrow.down.circle.fill")?.applying_hierarchical_tint()) { [weak self] _ in self?.demote_albums() }
	...
	private lazy var a_song_promote = UIAction(title: InterfaceText.Move_Up, image: UIImage(systemName: "arrow.up.circle.fill")?.applying_hierarchical_tint()) { [weak self] _ in self?.promote_songs() }
	private lazy var a_song_demote = UIAction(title: InterfaceText.Move_Down, image: UIImage(systemName: "arrow.down.circle.fill")?.applying_hierarchical_tint()) { [weak self] _ in self?.demote_songs() }
