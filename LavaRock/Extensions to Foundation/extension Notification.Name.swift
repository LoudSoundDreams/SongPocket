...
extension Notification.Name {
	...
	static let LRDidSaveChangesFromMusicLibrary = Notification.Name("MusicLibraryManager has saved changes from the built-in Music app’s library into the Core Data store. Instances that depend on the Core Data store should observe this notification and refresh their data now.")
