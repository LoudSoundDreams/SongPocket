...
extension AlbumsTVC: AlbumMoverDelegate {
	...
	// Call this from the modal `AlbumsTVC` in the “move albums to…” sheet after completing the animation for inserting the `Album`s we moved. This instance here, the non-modal `AlbumsTVC`, should be the modal `AlbumsTVC`’s delegate, and this method removes the rows for those `Album`s.
