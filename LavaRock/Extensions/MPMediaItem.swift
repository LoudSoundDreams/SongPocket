...
extension MPMediaItem {
	...
	// Behavior is undefined if you compare with an MPMediaItem from the same album.
	...
	// Behavior is undefined if you compare with an MPMediaItem from a different album.
